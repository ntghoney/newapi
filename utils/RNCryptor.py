...
class RNCryptor(object):
    ...
    def decrypt(self, data, password, iterations=10000):
        ...
        encryption_key = self._pbkdf2(password, encryption_salt, iterations)
        hmac_key = self._pbkdf2(password, hmac_salt, iterations)
    ...
    def encrypt(self, data, password, iterations=10000):
